// Unified File Manager shared between the browser extension and CLI tools.
// This implementation is copied from the browser extension utility so both
// environments share identical GitHub handling and file-organization logic.

import type { IDocumentMetadata, IFileOperationResult, IGitHubSettings } from '../types/index.js';
import { createConsoleLogger } from '../util/index.js';

const logger = createConsoleLogger('FileManager');
...
export class FileManager {
  ...
  private static readonly USER_AGENT = 'PrismWeave/1.0';
