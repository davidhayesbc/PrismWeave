...
import { BookmarkletGenerator, IBookmarkletConfig } from '../utils/bookmarklet-generator';
...
class BookmarkletGeneratorUI {
  ...
  handleSubmit(e: Event): void {
    ...
    try {
      const bookmarkletConfig = this.convertToBookmarkletConfig(formData);
      const bookmarkletCode = BookmarkletGenerator.generateBookmarklet(bookmarkletConfig, {
        minify: true,
