...
let captureManager: PageCaptureManager;

try {
  settingsManager = new SettingsManager();
  captureManager = new PageCaptureManager(settingsManager);
...
async function handleMessage(
  ...
  switch (message.type) {
    ...
    case 'TEST_CONNECTION':
      return await captureManager.testGitHubConnection();

    case 'CAPTURE_PAGE':
      return await captureManager.capturePage(message.data, {
