...
class UIUtils {
  ...
  static showStatus(message: string, type: StatusType = UIUtils.STATUS_TYPES.SUCCESS, duration: number = 5000): void {
  ...
  // Form utilities
  static populateForm(settings: Record<string, unknown>, fieldMapping: Record<string, string> = {}): void {
  ...
  static collectFormData(fieldMapping: Record<string, string> = {}, containerSelector: string = 'body'): Record<string, unknown> {
    ...
    const inputs = container.querySelectorAll('input, select, textarea') as NodeListOf<HTMLInputElement | HTMLSelectElement | HTMLTextAreaElement>;
  ...
  static validateField(fieldId: string, value: string, validationRules: IValidationRules = {}): string[] {
  ...
  static setButtonState(buttonId: string, disabled: boolean = false, text: string | null = null): void {
  ...
  static debounce<T extends (...args: unknown[]) => void>(func: T, delay: number = 300): (...args: Parameters<T>) => void {
...
if (typeof window !== 'undefined') {
  (window as IGlobalScope).UIUtils = UIUtils;
}

export default UIUtils;
export type { StatusType, IEventListener, IValidationRules, IModalOptions };
