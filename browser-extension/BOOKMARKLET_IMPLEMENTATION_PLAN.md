...
Create bookmarklet support for PrismWeave to enable web page capture functionality in environments where browser extensions are locked down or cannot be installed. The bookmarklet will reuse existing extension code with minimal refactoring to maintain feature parity.
...
### Phase 1: Code Analysis & Refactoring (Days 1-3) 🔄 **35% COMPLETE**
...
- [x] **Create shared utilities module** (`src/shared/`)
  ...
  - [ ] Extract and refactor `SettingsManager` for localStorage/API use
