...
// Shared utility that works in both browser extension and CLI/Puppeteer contexts
// Contains all core content extraction logic without any Chrome API dependencies
// This is a SHARED file copied from browser-extension/src/utils/content-extraction-core.ts
